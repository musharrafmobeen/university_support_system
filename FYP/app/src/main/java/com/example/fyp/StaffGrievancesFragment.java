...
public class StaffGrievancesFragment extends Fragment {
    ...
    Button approveBtn;
    public StaffGrievancesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_staff_grievances, container, false);
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            getGrievanceAssignedToAStaff(view);
    ...
    private void getGrievanceAssignedToAStaff(View view){
        recyclerView = (RecyclerView)view.findViewById(R.id.staffGrievanceRecyclerView);
        ...
        Call<GrievancesResult> call = retrofitInterface.getCertainGrievances("/grievances/androidApp/incharge/"+id);
        ...
        call.enqueue(new Callback<GrievancesResult>() {
            ...
            public void onResponse(Call<GrievancesResult> call, Response<GrievancesResult> response) {
                if (response.code() == 200) {
                    ...
                    Toast.makeText(getContext(),"These are the grievances that are assigned to you",Toast.LENGTH_LONG).show();
                }
