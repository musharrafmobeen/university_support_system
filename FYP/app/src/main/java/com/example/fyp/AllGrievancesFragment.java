...
public class AllGrievancesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_all_grievances, container, false);
    }
    ...
    private void allGrievances(){
        ...
        Call<GrievancesResult> call = retrofitInterface.getAllGrievances();
        ...
        call.enqueue(new Callback<GrievancesResult>() {
            ...
            public void onResponse(Call<GrievancesResult> call, Response<GrievancesResult> response) {
                if (response.code() == 200) {
                    ...
                    recyclerView = (RecyclerView)getView().findViewById(R.id.grievanceRecyclerView);
                    recyclerViewAdapter = new GrievanceRecyclerViewAdapter(grievanceList);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
                    recyclerView.setLayoutManager(layoutManager);
                    recyclerView.setAdapter(recyclerViewAdapter);
                    Toast.makeText(getContext(), "Showing All Grievances",
