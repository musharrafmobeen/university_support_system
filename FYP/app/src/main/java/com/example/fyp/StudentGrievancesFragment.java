...
public class StudentGrievancesFragment extends Fragment {
    ...
    public StudentGrievancesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_student_grievances, container, false);
    }
    ...
    private void getStudentGrievances(View view){
        try {
            recyclerView = (RecyclerView) view.findViewById(R.id.studentGrievanceRecyclerView);
            ...
            call.enqueue(new Callback<GrievancesResult>() {
                ...
                public void onResponse(Call<GrievancesResult> call, Response<GrievancesResult> response) {
                    if (response.code() == 200) {
                        ...
                        Toast.makeText(getContext(), "Showing All Your Lodged Grievances.",
