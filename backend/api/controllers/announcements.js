...
exports.get_Staff_Announcements = async (req, res, next) => {
 
  try {
    const allAnnouncementsDocs = await announcementModel
      .find({$or:[{visibleTo:"Staff"},{visibleTo:"All"}]})
      .exec();
...
exports.get_Students_Announcements = async (req, res, next) => {
 
  try {
    const allAnnouncementsDocs = await announcementModel
      .find({$or:[{visibleTo:"Student"},{visibleTo:"All"}]})
      .exec();
...
exports.get_VisibleToAll_Announcements = async (req, res, next) => {
