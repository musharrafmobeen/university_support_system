...
function StudentSideDrawer(props) {
    ...
    const showProfile = () => {
        setAnchorElAvatar(null);
        props.history.push("/student/my-profile");
    };
    const logUserOut = () => {
    ...
    if (Object.keys(currentUser).length !== 0 && userRole !== "Student") return returnToHome();
                ...
                >
                    ...
                    <List>
                        ...
                        <ListItem button key={"staff"}
                            onClick={() => {
                                props.history.push('/student/staff');
                            }}
                        ...
                        <ListItem button key={"docsRequested"}
                            onClick={() => {
                                props.history.push('/student/documents-requests');
                            }}
                        ...
                        <ListItem button key={"timeTable"}
                            onClick={() => {
                                props.history.push('/student/request-appointments');
                            }}
