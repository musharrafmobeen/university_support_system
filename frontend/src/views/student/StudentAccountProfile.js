...
function StudentAccountProfile(props) {
    const { classes } = props;
                ...
                Object.keys(currentAuth).length !== 0 && <div className={classes.profileCard}>
                    <UserProfile
                        values={{
                            ...
                            avatarSrc: currentAuth.studentImage ? `${baseUrl}/${currentAuth.studentImage}` : "",
                            email: currentAuth.email,
                            regNo: currentAuth.reg,
                            department: currentAuth.department,
                            isCurrentUser: true,
                            course: currentAuth.course,
                            userType: userRole,
                            id: currentAuth._id
                        }}
                    />
...
export default withStyles(styles)(StudentAccountProfile);