            ...
            const list = renderingStaff.slice(
                ...
                >
                    ...
                    <TableCell align="center"
                        ...
                        disabled={user.employee._id === currentAuth.employee._id}
                        onClick={
                            () => {
                                user.employee._id === currentAuth.employee._id ?
                                    props.history.push(`/staff/my-profile`)
                                    :
                                    props.history.push(`/staff/staff/${user._id}`);
                            }
                        }
                    >
                        {
                            user.employee._id === currentAuth.employee._id ? "YOU" :
                                user.employee.name
                        }
                    </TableCell>
                    ...
                    <TableCell align="right">
                        <Tooltip arrow title="View Schedule" classes={toolTipClasses}>
                            <IconButton
                                ...
                                onClick={() => {
                                    props.history.push(`/staff/staff/${user._id}/schedule`);
                                }}
                            >
                                <ScheduleIcon />
                            </IconButton>
...
export default withRouter(withStyles(styles)(StaffStaffs));