...
import { Backdrop, CircularProgress, Paper, Typography, useTheme, useMediaQuery, withStyles } from '@material-ui/core';
            ...
            <div>
                <div className={classes.parent}>
                    <div className={classes.heading}>
                        ...
                        <Typography className={classes.headingText}>Employee Specific Announcements</Typography>
                    </div>
