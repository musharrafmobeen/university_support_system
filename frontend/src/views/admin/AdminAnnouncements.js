    ...
    const renderAnnouncements = () => {
        ...
        const list = sorted.slice(
            ...
            <TableRow key={announ._id} component={Paper} className={classes.infoDataRow}>
                ...
                <TableCell align="center">{moment(announ.dateCreated).format("DD.MM.YYYY H:mm:ss a")}</TableCell>
        ...
        <div>
            ...
            <div className={classes.tableContainer}>
                ...
                <TablePagination
                    ...
                    component='div'
                    count={announcements.length}//{staff.length}
