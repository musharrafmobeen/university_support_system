...
import {
    ...
    Divider, IconButton, ListItem, ListItemIcon, ListItemText, withStyles, Hidden, Menu, MenuItem, Backdrop, CircularProgress
...
import RejectedRequestsIcon from '../../resources/design-icons/RejectedRequestsIcon';
...
function SideDrawer(props) {
    ...
    const showProfile = () => {
        setAnchorElAvatar(null);
        props.history.push("/admin/my-profile");
    };
    const logUserOut = () => {
    ...
    if (Object.keys(currentUser).length !== 0 && userRole !== "Admin") return returnToHome();
    return (
        <>
            ...
            <div className={classes.root}>
                ...
                >
                    ...
                    <List>
                        ...
                        <ListItem button key={"PendinRequests"}
                            onClick={() => {
                                props.history.push('/admin/pending-requests/students-requests');
                            }}
                            style={selection === "Pending-Requests" ? { backgroundColor: appBgColor, color: "white" } : {}}
                        >
                            <ListItemIcon>{<PendingRequestsIcon style={selection === "Pending-Requests" ? { color: "white" } : { color: iconColor }} />}</ListItemIcon>
                        ...
                        <ListItem button key={"categories"}
                            ...
                            style={selection === "Categories" ? { backgroundColor: appBgColor, color: "white" } : {}}
                        >
                            <ListItemIcon><CategoriesIcon style={selection === "Categories" ? { color: "white" } : { color: iconColor, }} /></ListItemIcon>
                        ...
                        <ListItem button key={"rejectedAccounts"}
                            onClick={() => {
                                props.history.push('/admin/rejected-accounts/students-accounts');
                            }}
                            style={selection === "Rejected-Accounts" ? { backgroundColor: appBgColor, color: "white" } : {}}
                        >
                            <ListItemIcon><RejectedRequestsIcon style={selection === "Rejected-Accounts" ? { color: "white" } : { color: iconColor, }} /></ListItemIcon>
                            <ListItemText primary="Rejected Accounts" />
                        </ListItem>
                                ...
                                <div className={classes.userMenuIcon}>
                                    ...
                                    >
                                        <Avatar
                                            ...
                                            src={`${configData.url.baseUrl}/${currentUser.adminImage}`}
