...
function AdminGrievances(props) {
    const { classes } = props;
    ...
    const getCount = () => {
        const pendingGrievances = grievances.filter(grievance => !grievance.isClosed);
        const closedGrievances = grievances.filter(grievance => grievance.isClosed === true);
        ...
        if (renderComponent === "all") renderingGrievances = grievances;
                ...
                <TableCell align="right" >
                    ...
                    <Tooltip arrow title="View Details" classes={toolTipClasses}>
                        <IconButton
                            ...
                            onClick={
                                () => {
                                    props.history.push(`/admin/grievances/${grievance._id}`);
                                }
                            }
                        >
                            <Visibility />
...
export default withRouter(withStyles(styles)(AdminGrievances));